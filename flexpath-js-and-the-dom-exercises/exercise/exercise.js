...
const parentNode = introduction.parentNode;

console.log("Introduction parent is : ", parentNode);
...
console.log("Child elements in Item List", itemList.children.length);
...
// introduction.innerHTML += "This content has been updated!";
...
//   console.log("Event listener removed after 5 seconds.");
// }, 5000);
...
interactive.addEventListener("click", function () {
  console.log("Interaction section clicked");
});

colorButton.addEventListener("click", function (e) {
  e.stopPropagation();
  console.log("Color Button Clicked");
  const currentColor = getComputedStyle(colorButton).backgroundColor;
  console.log("The actual background color is:", currentColor);
